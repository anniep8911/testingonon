import { SinglePage } from './Select-Box-PC.js';
import { marked } from 'marked';
import makeStories from '../../fnc.js';

let path = '컴포넌트/Form/PC/Select-Box';
...
const stories = makeStories(SinglePage, md, ['default', 'option-opened', 'option-disabled', 'disabled'], 'both', ['pc', 'select-box']);
