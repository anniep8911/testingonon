import { SinglePage } from './Select-Line-PC.js';
import { marked } from 'marked';
import makeStories from '../../fnc.js';

let path = '컴포넌트/Form/PC/Select-Line';
...
const stories = makeStories(SinglePage, md, ['default', 'option-opened', 'disabled'], 'both', ['pc', 'select-line']);
