...
let path = '컴포넌트/Button/MOB/Button';

let 공통다큐먼트 = `
<ul>
  <li>모바일용 버튼 컴포넌트로 다양한 스타일과 상태를 지원합니다</li>
  ...
  <li>모바일 버튼은 width: 100%로 전체 너비를 차지합니다</li>
</ul>
`;
...
// 🔹 스토리 생성 (자동 등록)
const stories = makeStories(SinglePage, md, ['large', 'medium', 'small', 'xsmall'], 'both',['mob','button']);
